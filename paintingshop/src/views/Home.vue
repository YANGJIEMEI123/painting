  ...
  <div >
    ...
    <div class="body1">
      ...
      <div class="menu">
        ...
        <span @click="sketch">花鸟画</span>
        <span @click="qi">素描</span>
        <span @click="china">漆画</span>
      </div>
      <div class="list">
        <!-- 图片列表 -->
        <div class="demo-image">
          <div class="i" v-for="url in dataShow" :key="url.gid">
            <router-link to="/detail">
              <el-image style="width: 240px; height: 240px" :src="url.img" @click="usegid(url)"></el-image>
            </router-link>
            <div class="price">
              ￥{{url.price}}
              <span class="iconfont icon-99yuanbaoyou logo"></span>
            </div>
      ...
      this.axios
        ...
        .then(response => {
          ...
          for (var i = 0; i < this.pageNum; i++) {
            this.totalPage[i] = this.imgs.slice(
              this.pageSize * i,
              this.pageSize * (i + 1)
            );
          }
